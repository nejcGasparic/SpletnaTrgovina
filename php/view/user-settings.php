...
<body>
    ...
    <div class="container light-style flex-grow-1 container-p-y">
        <form action="<?= BASE_URL . $_SESSION["roleName"] ."user" ?>" method="post">
                    ...
                    <div class="tab-pane fade active show" id="account-general">
                      ...
                      <div class="card-body">
                            <div class="form-group">
                              ...
                              <input type="text" name="name" class="form-control mb-1" value="<?= $user["ime_uporabnika"]?>">
                            </div>
                            <div class="form-group">
                              <label class="form-label">Priimek uporabnika</label>
                              <input type="text" name="surname" class="form-control" value="<?= $user["priimek_uporabnika"]?>">
                            </div>
                            <div class="form-group">
                              <label class="form-label">E-mail</label>
                              <input type="email" name="email" class="form-control mb-1" value="<?= $user["elektronski_naslov"]?>">
                            </div>
                            <div class="form-group">
