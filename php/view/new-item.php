...
<body>
    ...
    <div class="container light-style flex-grow-1 container-p-y">
        <form action="<?= BASE_URL . $_SESSION["roleName"] ."createItem" ?>" method="post">
                    ...
                    <div class="tab-pane fade active show" id="account-general">
                      ...
                      <div class="card-body">
                            ...
                            <div class="form-group">
                              ...
                              <input type="float" name="price" class="form-control" value="">
                            </div>
                      </div>
                    </div>
                    </div>
          ...
          <div class="modal-dialog" role="document">
            <div class="modal-content">
              ...
              <div class="modal-body">
                <p><?=nl2br($_SESSION["newSellerPassword"])?></p>
              </div>
...
<script>
    /*
    var message = <?= isset($_SESSION["newSellerPassword"]) ? json_encode($_SESSION["newSellerPassword"]) : '""' ?>;
