...
<meta charset="UTF-8" />
<title>Nastavitve prodajalcev</title>
        ...
        <ul class="navbar-nav ml-auto">
          ...
          <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu" aria-labelledby="navbarDropdown" style="right: 0; left: auto;">
              ...
              <a class="dropdown-item d-none" id="nastavitveArtiklov" href="#">Artikli</a>
              <a class="dropdown-item d-none" id="nastavitveStranke" href="#">Stranke</a>
            </div>
          </li>
          <li class="nav-item">
    ...
    <div class="container light-style flex-grow-1 container-p-y">
        ...
        <div id="accordion">
            <?php foreach ($sellers as $seller): ?>
                <div class="card">
                  <div class="card-header" id="<?= $seller["ime_uporabnika"]?>">
                    <h5 class="mb-0">
                      <button class="btn btn-link collapsed" data-toggle="collapse" data-target="#<?= $seller["id_uporabnika"]?>" aria-expanded="false" aria-controls="<?= $seller["id_uporabnika"]?>">
                        <?= $seller["ime_uporabnika"] ?>
                      </button>
                    </h5>
                  </div>

                  <div id="<?= $seller["id_uporabnika"]?>" class="collapse" aria-labelledby="<?= $seller["ime_uporabnika"]?>" data-parent="#accordion">
                    <div class="card-body">
                    <form action="<?= BASE_URL . "seller/user" ?>" method="post">
                        <input type="hidden" name="id" value="<?= $seller["id_uporabnika"]?>"/>
                        <h4 class="font-weight-bold pt-4 mb-2">
                          Nastavitve računa
                        </h4>
                                ...
                                <div class="tab-pane fade active show" id="account-general">
                                  ...
                                  <div class="card-body">
                                        <div class="form-group">
                                          ...
                                          <input type="text" name="name" class="form-control mb-1" value="<?= $seller["ime_uporabnika"]?>">
                                        </div>
                                        <div class="form-group">
                                          <label class="form-label">Priimek uporabnika</label>
                                          <input type="text" name="surname" class="form-control" value="<?= $seller["priimek_uporabnika"]?>">
                                        </div>
                                        <div class="form-group">
                                          <label class="form-label">E-mail</label>
                                          <input type="email" name="email" class="form-control mb-1" value="<?= $seller["elektronski_naslov"]?>">
                                        </div>
                                        <div class="form-group">
