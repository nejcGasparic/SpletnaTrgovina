                              ...
                              <div class="tab-content">
                                <div class="tab-pane fade active show" id="account-general">
                                  ...
                                  <div class="card-body">
                                            ...
                                            <?php
                                                if($order["Status_id_statusa"] == "1"){
                                                ?>
                                                    <form action="<?= BASE_URL . "confirm-order" ?>" method="post">
                                                        <input type="hidden" name="id" value="<?= $order["id_naročila"]?>"/>
                                                        <button class="btn btn-secondary">Potrdi</button>
                                                    </form>
                                                    <form action="<?= BASE_URL . "cancel-order" ?>" method="post">
                                                        <input type="hidden" name="id" value="<?= $order["id_naročila"]?>"/>
                                                        <button class="btn btn-secondary">Prekliči</button>
                                                    </form>                                                
                                                    </form>
                                            <?php
                                                }
                                                else if($order["Status_id_statusa"] == "2"){
                                                ?>
                                                    <form action="<?= BASE_URL . "terminate-order" ?>" method="post">
                                                        <input type="hidden" name="id" value="<?= $order["id_naročila"]?>"/>
                                                        <button class="btn btn-secondary">Storniraj</button>
                                                    </form>                                                    
                                            <?php
                                                }
                                            ?>                                            
